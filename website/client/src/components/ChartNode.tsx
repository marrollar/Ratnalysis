...
// TODO: The skeleton works but plot doesn't rerender properly. Related to TODO in ChartsSideBar
const PlotSkeleton = () => (
    <div className="w-[1000px] h-[400px] flex justify-center items-center bg-[#253142]">
...
function ChartNode({ data }: ChartNodeData) {
    ...
    return (
        <div className="flex flex-grow bg-gray-500 p-0.5">
            ...
            {!localData ? (
                ...
                <>
                    <Plot
                        data={localData.pjson.data}
                        layout={localData.pjson.layout}
                        frames={localData.pjson.frames}
                        config={localData.pjson.config}
